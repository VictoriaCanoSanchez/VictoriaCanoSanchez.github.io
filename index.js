    ...
    function w3_open(){
      ...
      document.querySelectorAll('header .w3-button[aria-controls="barra"]')
    ...
    function toggleMenu(){ document.body.classList.contains("drawer-open")? w3_close(): w3_open(); }
    ...
    function setActiveLink(sectionId){
      ...
      var active=Array.prototype.find.call(links,l=>l.getAttribute("href")==="#"+sectionId);
      if(active){ active.classList.add("w3-white-active"); active.setAttribute("aria-current","page"); }
    }
    ...
    window.onload=function(){
      ...
      showSection(hash || "acerca");     // siempre mostrar "acerca" por defecto
